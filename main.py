...
def get_model(): 
    config = OmegaConf.load("ldm.yaml")  
...
input_res = 224
cle_data_path = '/cle_data'  # original image
...
cle_data_path = '/cle_data' # original image
tgt_data_path = '/tgt_data' # target image
batch_size = 1
num_samples = 1000
...
import pandas as pd
data = pd.read_csv('images.csv')  # label
labeles = {}
for i in range(1000):
